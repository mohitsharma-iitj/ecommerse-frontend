...
import { FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, Pagination } from '@mui/material'
                ...
                <main className="mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            <div><h1 className='text-lg opacity-50 font-bold'>Filters</h1>
                                ...
                                <div className='flex flex-wrap justify-center bg-white py-5'>
                                    {
                                        product.products?.content?.length > 0 ? (
                                            product.products.content.map((item) => (
                                                <ProductCard key={item.id} product={item} /> // Make sure to add a key prop
                                            ))
                                        ) : (
                                            <p>No products found</p> // Fallback message when no products are available
                                        )
